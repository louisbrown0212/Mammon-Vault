...
import "./libraries/SmartPoolManagerMock.sol";
    ...
    ReentrancyGuard
{
    ...
    SmartPoolManagerMock.GradualUpdateParams private gradualUpdate;
    ...
    function updateWeightsGradually(
        ...
        SmartPoolManagerMock.updateWeightsGradually(
            pool,
            gradualUpdate,
            newWeights,
            startBlock,
    ...
    function pokeWeights()
        ...
        nonFinalizing
    {
        SmartPoolManagerMock.pokeWeights(pool, gradualUpdate);
    }
